...
class PageGeneralDetail extends StatefulWidget {
  ...
  const PageGeneralDetail({super.key, required this.itemId});

  @override
  State<PageGeneralDetail> createState() => _PageGeneralDetailState();
}
...
class _PageGeneralDetailState extends State<PageGeneralDetail> {
  ...
  // --------------------------------------------------
  void _loadItemData() {
    _itemData = TempItems.generalItems.firstWhere((item) => item.id == widget.itemId, orElse: () => throw Exception('상품을 찾을 수 없습니다.'));
  }
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: RichText(
                          text: TextSpan(
                            text: '${MyFN.discountRate(_itemData!.originalPrice, _itemData!.price)}%',
