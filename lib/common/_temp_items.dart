...
class TempItems {
  ...
  static final List<AuctionItem> auctionItems = [
    ...
    AuctionItem(
      ...
      lastPrice: 650,
      endTime: DateTime.now().add(const Duration(days: 1)),
      thumbnail: 'https://image.istarbucks.co.kr/upload/store/skuimg/2025/06/[9200000004750]_20250626093847447.jpg',
      isWished: false,
    ),
  ];
  ...
  static final List<GeneralItem> generalItems = [
    ...
    GeneralItem(brand: '교촌치킨', name: '모둠어묵탕[홀전용]', originalPrice: 16000, price: 13000, thumbnail: 'https://www.kyochon.com/uploadFiles/TB_ITEM/list_fishcake.png'),
    GeneralItem(
      brand: '교촌치킨',
      name: '레드스틱[S]',
      originalPrice: 13000,
