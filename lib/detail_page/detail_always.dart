...
// DetailAlways
// ====================================================================================================
class DetailAlways extends StatefulWidget {
  final String itemId;

  const DetailAlways({super.key, required this.itemId});

  @override
  State<DetailAlways> createState() => _DetailAlwaysState();
}

class _DetailAlwaysState extends State<DetailAlways> {
