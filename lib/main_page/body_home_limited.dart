        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount: _onSaleItemDatas.length,
              itemBuilder: (context, index) {
                return _todaysLimitedDealCard(_onSaleItemDatas[index]);
              },
            ),
          ),
          ...
          // ----- 다가오는 한정특가 리스트 -----
          Column(children: _readyItemDatas.map((item) => _readyLimitedDealCard(item)).toList()),
          SizedBox(height: 120),
        ],
      ),
    );
